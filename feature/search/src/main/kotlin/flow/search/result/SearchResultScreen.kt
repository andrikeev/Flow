...
import flow.search.filter.FilterBar
import flow.search.result.SearchResultAction.BackClick
import flow.search.result.SearchResultAction.FavoriteClick
import flow.search.result.SearchResultAction.ListBottomReached
import flow.search.result.SearchResultAction.RetryClick
import flow.search.result.SearchResultAction.SearchClick
import flow.search.result.SearchResultAction.TorrentClick
    ...
    LazyList(
        ...
        when (state.content) {
            is SearchResultContent.Initial -> when (state.loadStates.refresh) {
                ...
                is LoadState.Error -> errorItem(onRetryClick = { onAction(RetryClick) })
            }
