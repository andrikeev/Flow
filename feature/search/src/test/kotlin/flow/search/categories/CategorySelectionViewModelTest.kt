...
import flow.search.domain.models.ForumTreeItem.Group
import flow.search.domain.models.ForumTreeItem.Root
...
import flow.testing.repository.TestForumRepository
...
class CategorySelectionViewModelTest {
    private val forumRepository = TestForumRepository()
    ...
    fun `Set selected items`() = runTest {
        // set
        forumRepository.forumTree = TestForumRepository.TestForumTree
