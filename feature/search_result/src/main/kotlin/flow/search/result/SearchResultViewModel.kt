...
import flow.domain.usecase.GetSearchPageUseCase
...
internal class SearchResultViewModel @Inject constructor(
    ...
    private fun loadFirstPage() = intent {
        ...
        viewModelScope.launchCatching(
            ...
            val searchPage = getSearchPageUseCase(state.filter, 1)
    ...
    private fun onListBottomReached() = intent {
        ...
        if (
            ...
            viewModelScope.launchCatching(
                ...
                val searchPage = getSearchPageUseCase(state.filter, content.page + 1)
                enrichScope.relaunch {
